...
const AXES = [
  ...
  { num: "07", title: "الذكاء الاصطناعي وصناعة القرار", items: ["أدوات AI", "AI Agents", "تحليل البيانات", "التنبؤ", "اتخاذ القرار", "الأتمتة", "AI Governance", <a href="https://www.auditingartificialwisdom.com/" target="_blank" rel="noopener noreferrer" className="hover:underline text-blue-400">Artificial Wisdom</a>] },
